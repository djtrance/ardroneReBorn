...
echo ""
echo "Kernel modules (.ko) will be deployed to /data/video/."
echo "On drone, load with: insmod /data/video/<module>.ko"
echo ""
...
echo "  test_wifi_caps    — WiFi monitor mode / raw socket test"
echo "  test_uvc_camera   — USB UVC camera via libusb"
echo "  test_gps          — GPS NMEA parser (needs serial drivers)"
echo "  test_modem        — 4G/5G modem AT + connectivity test"
echo ""
echo "Tools in tools/:"
echo "  linux-kernel/build_modules.sh  — Build all kernel .ko modules"
echo "  wfb-bridge/wfb_tx.c           — wifibroadcast transmitter"
